...
class BuyCompanyPage(BasePage):

    ADD_BTN = (By.XPATH, "//button[contains(text(),'Add')]")
    DROP_DOWN = (By.XPATH, "//span[contains(text(),'Select Buyer Group')]")
    OPTION = (By.XPATH, "//span[contains(text(), ' Haq Group ')]")
    INPUT_TEXTBOX1 = (By.XPATH, "//input[@placeholder='Enter Buyer Company name']")
    ...
    def __init__(self, driver):
        ...
        if self.driver.current_url == TestData.BUYCOMPANY_URL:
            pass
        else:
            self.driver.get(TestData.BUYCOMPANY_URL)
