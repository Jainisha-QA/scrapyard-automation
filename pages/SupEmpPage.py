...
class SupEmpPage(BasePage):

    ADD_BTN = (By.XPATH, "//button[contains(text(),'Add')]")
    DROP_DOWN1 = (By.XPATH, "//span[contains(text(),'Select Supplier Group')]")
    DROP_DOWN2 = (By.XPATH, "//span[contains(text(),'Select Supplier Company')]")
    OPTION1 = (By.XPATH, "//span[contains(text(), 'Stamcorp - Amit bhai')]")
    OPTION2 = (By.XPATH, "//span[contains(text(), ' Stamcorp International Pte Ltd ')]")
    INPUT_TEXTBOX1 = (By.XPATH, "//input[@placeholder='Enter First Name']")
    INPUT_TEXTBOX2 = (By.XPATH, "//input[@placeholder='Enter Last Name']")
    INPUT_TEXTBOX3 = (By.XPATH, "//input[@placeholder='Enter Designation']")
    INPUT_TEXTBOX4 = (By.XPATH, "//input[@placeholder='Enter Password']")
    INPUT_TEXTBOX5 = (By.XPATH, "//input[@placeholder='Enter role']")
    ...
    def __init__(self, driver):
        ...
        if self.driver.current_url == TestData.SUPEMP_URL:
            pass
        else:
            self.driver.get(TestData.SUPEMP_URL)
