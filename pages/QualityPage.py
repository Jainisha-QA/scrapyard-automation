...
class QualityPage(BasePage):
    ...
    INPUT_TEXTBOX2 = (By.XPATH, "//textarea[@placeholder='Enter description']")
    ...
    def __init__(self, driver):
        ...
        if self.driver.current_url == TestData.QUALITY_URL:
            pass
        else:
            self.driver.get(TestData.QUALITY_URL)
    ...
    def check_placeholder(self):
        placeholder1 = self.get_attribute_element(self.INPUT_TEXTBOX1, "placeholder")
        placeholder2 = self.get_attribute_element(self.INPUT_TEXTBOX2, "placeholder")
