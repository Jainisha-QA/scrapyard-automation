...
class ContainerPage(BasePage):
    ...
    INPUT_TEXTBOX = (By.XPATH, "//input[@placeholder='Enter container name']")
    ...
    def __init__(self, driver):
        ...
        if self.driver.current_url == TestData.CONTAINERS_URL:
            pass
        else:
            self.driver.get(TestData.CONTAINERS_URL)
