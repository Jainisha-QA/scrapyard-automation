...
class PlantPage(BasePage):
    ...
    INPUT_TEXTBOX1 = (By.XPATH, "//input[@placeholder='Enter address']")
    INPUT_TEXTBOX2 = (By.XPATH, "//input[@placeholder='Enter capacity']")
    INPUT_TEXTBOX3 = (By.XPATH, "//input[@placeholder='Enter Production Capacity']")
    ...
    def __init__(self, driver):
        ...
        if self.driver.current_url == TestData.PLANT_URL:
            pass
        else:
            self.driver.get(TestData.PLANT_URL)
    ...
    def check_require_msg(self):
        ...
        msg2 = self.below_element_text(self.INPUT_TEXTBOX3, self.REQUIRE_MSG[1])
    ...
    def check_placeholder(self):
        ...
        msg2 = self.get_attribute_element(self.INPUT_TEXTBOX3, "placeholder")
