...
class MatCategoryPage(BasePage):

    ADD_BTN = (By.XPATH, "//button[contains(text(),'Add')]")
    INPUT_TEXTBOX = (By.XPATH, "//input[@placeholder='Enter Material category name']")
    ...
    def __init__(self, driver):
        ...
        if self.driver.current_url == TestData.MATCATEGORY_URL:
            pass
        else:
            self.driver.get(TestData.MATCATEGORY_URL)

    def check_login(self):
        return self.access_localstorage()
