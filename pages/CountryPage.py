...
class CountryPage(BasePage):
    ...
    INPUT_TEXTBOX = (By.XPATH, "//input[@placeholder='Enter country of origin name']")
    ...
    def __init__(self, driver):
        ...
        if self.driver.current_url == TestData.COUNTRY_URL:
            pass
        else:
            self.driver.get(TestData.COUNTRY_URL)
