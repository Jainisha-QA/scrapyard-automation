...
class ImpurityPage(BasePage):

    ADD_BTN = (By.XPATH, "//button[contains(text(),'Add')]")
    INPUT_TEXTBOX = (By.XPATH, "//input[@placeholder='Enter Impurity Tolerance']")
    ...
    def __init__(self, driver):
        ...
        if self.driver.current_url == TestData.IMPURITY_URL:
            pass
        else:
            self.driver.get(TestData.IMPURITY_URL)
    ...
    def check_placeholder(self):
        msg = self.get_attribute_element(self.INPUT_TEXTBOX, "placeholder")
